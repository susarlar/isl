...
Neptune (120 base aptitude) at Level 500:
- Base: 120 x 7,590 = **910,800**
- +100 aptitude from Skill Pearls: 220 x 7,590 = **1,669,800** (+83% power!)
- +300 aptitude (all caps): 420 x 7,590 = **3,187,800** (+250% over base!)

And remember — this base power then gets multiplied by awakening %, artifacts, Advanced Blessing, and Stella. Aptitude is the foundation that everything else scales from.
