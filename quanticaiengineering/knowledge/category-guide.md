# Category Investment Guide — "I Main X" Quick Reference

This guide connects all systems together by aptitude category. When a player says "I main Inspiring" (or Brave, Diligent, etc.), this is everything they need to know.

---

## I Main Inspiring

### Top Inspiring Fellows
...
**Aptitude fish (high value):**
4. Bonefish (Northrealm) — Inspiring Aptitude + Inspiring % gold crown
5. Megakarp (Village) — Inspiring Aptitude + Inspiring % gold crown
6. Nudibranch, Dumbo Octopus, Piranhape (All Fellow Aptitude → All Fellow % gold crown)

**Flat fish (low priority):** Lobster, Aquafrog (Inspiring flat)

---

## I Main Diligent

### Top Diligent Fellows
...
- Look for family/Stella that boosts Diligent category

### Family Blessings — Who to Date
Check blessing chart for families that bless your specific Diligent fellows. Key families:
- **Denier** (3x) → Tigirl, Loya, Andras
- **Epona** (2x) → Loya, Adeline

### Fish Priority
**% Power fish:**
1. Ocean top 5 (All Fellow %)
2. Snow Leopard Fish (Northrealm) — Diligent %
3. Pirarucu (Drakenberg) — Diligent %

**Aptitude fish:**
4. Comb Jelly (Northrealm) — Diligent Aptitude + % gold crown
5. Alligator Snapping Turtle (Drakenberg) — Diligent Aptitude + % gold crown

**Flat fish (low priority):** Snakehead, Flower Crab
...
### Family Blessings — Who to Date
Key families blessing Brave fellows:
- **Kagura** (3x) → Iori, **Salvo**, Orivita
- **Baity** (3x) → **Salvo**, Anne, Hermes
- **Willo** (3x) → **Kaye**, Ira, Andras
- **Holly** (3x) → Tigirl, Lux, Leon
- **Mater** (2x) → Adeline, **Kaye**

### Fish Priority
**% Power fish:**
1. Ocean top 5 (All Fellow %)
2. Narwhal (Northrealm) — Brave %
3. Gold Pirarucu (Drakenberg) — Brave %

**Aptitude fish:**
4. Sea Butterfly (Northrealm) — Brave Aptitude + % gold crown
5. Hermit Crab (Village) — Brave Aptitude + % gold crown

**Flat fish (low priority):** Sturgeon, Oyster
...
### Stella Investment
- **Angie** → Boosts ALL Informed fellows' power
- Look for additional Informed Stella characters
...
**% Power fish:**
1. Ocean top 5 (All Fellow %)
2. Fin Whale (Northrealm) — Informed %
3. Star Anglerfish (Drakenberg) — Informed %

**Aptitude fish:**
4. Bloodbelly Comb Jelly (Northrealm) — Informed Aptitude + % gold crown
5. Anglerfish (Ocean) — Informed Aptitude + % gold crown

**Flat fish (low priority):** Giant Oarfish, Guppy
...
### Stella Investment
- Push Stella on whoever boosts Unfettered category
- **Orivita** is the top Unfettered carry (120 apt) — pair her with maximum multipliers

### Family Blessings — Who to Date
Key families blessing Unfettered fellows:
- **Kosuzu** (3x) → Avar, **Orivita**, Neptune (Orivita is Unfettered!)
- **Kagura** (3x) → Iori, Salvo, **Orivita**
- Flexible slot families (Lancelot, Magellan, Jewlry) — assign to Orivita

### Top Unfettered Fellows
| Fellow | Base Aptitude | Rarity | Notes |
|--------|-------------|--------|-------|
...
### Family Blessings — Who to Date
Check blessing chart for families that bless your specific Unfettered fellows.

### Fish Priority
**% Power fish:**
1. Ocean top 5 (All Fellow %)
2. Sea Angel (Northrealm) — Unfettered %
3. Drakenberg Monster (Drakenberg) — Unfettered %

**Aptitude fish:**
4. Goddess Sponge (Northrealm) — Unfettered Aptitude + % gold crown

**Flat fish (low priority):** Sardine, Sea Anemone

---

## Universal Advice (All Categories)

### Every Player Should:
1. **Fish the Ocean top 5** (Sperm Whale, Giant Squid, Helicoprion, Smooth Hammerhead, Mosasaurus) — All Fellow Power % benefits everyone
2. **Level Nudibranch, Dumbo Octopus, Piranhape** — All Fellow Aptitude (normal) + All Fellow % (gold crown)
